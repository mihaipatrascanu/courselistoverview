...
$plugin->requires  = 2022110100;        // Requires this Moodle version - THIS IS 4.1dev+ (Build: 20221101)
$plugin->component = 'report_courselistoverview'; // Full name of the plugin (used for diagnostics).
$plugin->release = '1';
